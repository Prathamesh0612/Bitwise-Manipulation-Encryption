...
// This is the corrected version with no duplicates.
// -----------------------------------------------------------------
class NECrypto {
    constructor() {
        this.VERSION = 1;
...
// This class contains all the functions to control the webpage
// and the *correctly placed* `encryptFile` function.
// -----------------------------------------------------------------
class NECApp {
    constructor() {
    ...
    initializeUI() {
        ...
        // This querySelector was WRONG in your original file. It's now fixed.
        ...
        // This listener was for a different button, the dynamic one is now handled by the one above.
    ...
    // --- THIS IS THE FUNCTION THAT WAS MISPLACED ---
    async encryptFile() {
        if (!this.currentFile) {
